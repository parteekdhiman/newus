    ...
    try {
      ...
      if (result.ok) {
        if (result.emailSent) {
          ...
          alert(
            "Subscription received but there was an issue. Please try again."
          );
        }
      } else {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-1 lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/newus.dharamshala.2025/"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/company/newus-dharamshala/posts/?feedView=all"
                className="text-gray-400 hover:text-white"
                target="_blank"
              >
                <svg
              ...
              <a
                href="https://www.instagram.com/newusdharamshala/"
                target="_blank"
                className="text-gray-400 hover:text-white"
              >
                <svg
          ...
          <div>
            ...
            <ul className="space-y-2">
              {CoursesList.filter((fill) => fill.navbar === true)
                .slice(0, 6)
                .map((items, index) => {
            ...
            {subscribed ? (
              ...
              <form onSubmit={subscribe} className="space-y-3">
                ...
                <p className="text-xs text-gray-400">
                  Get updates about courses, webinars and offers.
                </p>
              </form>
            )}
          </div>
